...
template void ck_grouped_gemm<ck_tile::fp8_t, ck_tile::fp8_t, ck_tile::half_t>(
    const CKGroupedGemmParams<ck_tile::fp8_t, ck_tile::fp8_t, ck_tile::half_t> &params);

// bf8 * bf8 -> fp16
template void ck_grouped_gemm<ck_tile::bf8_t, ck_tile::bf8_t, ck_tile::half_t>(
    const CKGroupedGemmParams<ck_tile::bf8_t, ck_tile::bf8_t, ck_tile::half_t> &params);

// fp8 * fp8 -> bf16
template void ck_grouped_gemm<ck_tile::fp8_t, ck_tile::fp8_t, ck_tile::bfloat16_t>(
    const CKGroupedGemmParams<ck_tile::fp8_t, ck_tile::fp8_t, ck_tile::bfloat16_t> &params);

// bf8 * bf8 -> bf16
template void ck_grouped_gemm<ck_tile::bf8_t, ck_tile::bf8_t, ck_tile::bfloat16_t>(
    const CKGroupedGemmParams<ck_tile::bf8_t, ck_tile::bf8_t, ck_tile::bfloat16_t> &params);
