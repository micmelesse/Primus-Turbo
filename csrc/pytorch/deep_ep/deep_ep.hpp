...
struct Buffer {
  public:
    ...
    bool is_low_latency_optimize() const;
    ...
    void
    sync_pxn_handles(const std::vector<int>                                &device_ids,
                     const std::vector<std::optional<pybind11::bytearray>> &all_gathered_handles);
    ...
    void        sync_string(const std::vector<int>         &device_ids,
  ...
  private:
    ...
    void   *buffer_ptrs[NUM_MAX_XGMI_PEERS] = {nullptr};
    void  **buffer_ptrs_gpu                 = nullptr;

    bool   low_latency_optimize                = false;
    void  *nvl_buffer_ptrs[NUM_MAX_XGMI_PEERS] = {nullptr};
    ...
    hipIpcMemHandle_t ipc_handles[NUM_MAX_XGMI_PEERS];
    hipIpcMemHandle_t pxn_ipc_handles[NUM_MAX_XGMI_PEERS];
    ...
    // Task fifo
    int   head                               = 0;
    int  *task_fifo_ptrs[NUM_MAX_XGMI_PEERS] = {nullptr};
